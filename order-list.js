...
function displayOrderList() {
    ...
    getDocs(allOrders)
        .then((docs) => {
            let orderListElements = '<thead><tr><th>Order Id</th><th>Order Status</th><th>QTY</th><th>Product</th><th>UPC</th><th>App Date</th><th>Due Date</th><th>Packing Slip</th></tr></thead><tbody>'
            docs.forEach(order => {
